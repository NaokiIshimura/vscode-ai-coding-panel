...
Plans Viewのルートディレクトリにおいて、ファイル/ディレクトリ名の前に日付または時間を表示する機能を実装：

**表示形式**
- 当日以外: `[MM/DD] ファイル名`（例: `[01/28] 2026_0128_1430_25_TASK.md`）
- 当日: `[HH:MM] ファイル名`（例: `[09:54] 2026_0129_0954_07_TASK.md`）
