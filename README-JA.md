...
| コマンド種別アイコン | Editor viewからコマンドを実行すると、タブ名にコマンド種別アイコン（▶️ Run、📝 Plan、📑 Spec）を表示 |
...
2. コマンドラインからインストール:
   ```bash
   code --install-extension ai-coding-sidebar-0.9.6.vsix
   ```
3. VS Codeを再起動
...
code --install-extension releases/ai-coding-sidebar-0.9.6.vsix
```
