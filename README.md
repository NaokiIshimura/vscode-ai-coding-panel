...
[![Version](https://img.shields.io/badge/version-1.0.14-blue.svg)](https://marketplace.visualstudio.com/items?itemName=nacn.ai-coding-sidebar) [![VS Marketplace](https://img.shields.io/badge/VS%20Marketplace-Install-blue.svg)](https://marketplace.visualstudio.com/items?itemName=nacn.ai-coding-sidebar)
...
2. Install via command line:
   ```bash
   code --install-extension ai-coding-sidebar-1.0.14.vsix
   ```
3. Restart VS Code.
...
code --install-extension releases/ai-coding-sidebar-1.0.14.vsix
```
